...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('etudiant.demande.index') }}" class="{{ request()->routeIs('etudiant.demande.index') ? 'active' : '' }}">
                <i class="bi bi-file-earmark-text-fill"></i> Mes demandes
            </a>
            <a href="{{ route('etudiant.demande.create') }}" class="{{ request()->routeIs('etudiant.demande.create') ? 'active' : '' }}">
    ...
    <div class="main">
        <div class="topbar">
            ...
            <a href="{{ route('etudiant.demande.create') }}" class="btn btn-primary"><i class="bi bi-plus-lg"></i> Nouvelle demande</a>
        </div>
